...
export const LESSON_CATALOG: Lesson[] = [
  ...
  /* ══════════════════════════════════════════════════════
     Investing expansion — Stocks, ETFs, Bonds, CDs, etc.
  ══════════════════════════════════════════════════════ */
  { id: "stocks-101", title: "Stocks 101", description: "What a share of stock is and how stock investing works.", level: "level-2", tags: ["stocks", "investing-basics", "visual-heavy", "level-2"], estimatedTimeMin: 8, sources: [{ name: "SEC — What Are Stocks?", url: "https://www.investor.gov/introduction-investing/investing-basics/investment-products/stocks", type: "government", lastReviewed: "2026-01-01" }] },
  { id: "etfs-index-funds", title: "ETFs & Index Funds", description: "Low-cost baskets of stocks or bonds for diversification.", level: "level-2", tags: ["etfs", "investing-basics", "visual-heavy", "level-2"], estimatedTimeMin: 8, sources: [{ name: "SEC — Mutual Funds and ETFs", url: "https://www.investor.gov/introduction-investing/investing-basics/investment-products/mutual-funds-and-exchange-traded-funds-etf", type: "government", lastReviewed: "2026-01-01" }] },
  { id: "bonds-101", title: "Bonds 101", description: "How bonds work and when they fit your plan.", level: "level-2", tags: ["bonds", "investing-basics", "level-2"], estimatedTimeMin: 7, sources: [{ name: "SEC — What Are Bonds?", url: "https://www.investor.gov/introduction-investing/investing-basics/investment-products/bonds-or-fixed-income-products", type: "government", lastReviewed: "2026-01-01" }] },
  { id: "cds-101", title: "CDs 101", description: "Certificate of deposit basics and when to use them.", level: "level-1", tags: ["cds", "money-basics", "level-1"], estimatedTimeMin: 5, sources: [{ name: "FDIC — Certificates of Deposit", url: "https://www.fdic.gov/resources/deposit-insurance/financial-products/certificates-of-deposit/", type: "regulator", lastReviewed: "2026-01-01" }] },
  { id: "asset-allocation", title: "Asset Allocation (Educational Examples Only)", description: "How to think about splitting money between stocks, bonds, and cash.", level: "level-2", tags: ["asset-allocation", "investing-basics", "visual-heavy", "level-2"], estimatedTimeMin: 8, sources: [{ name: "SEC — Asset Allocation", url: "https://www.investor.gov/introduction-investing/investing-basics/investment-products/asset-allocation", type: "government", lastReviewed: "2026-01-01" }] },
  { id: "brokerage-accounts", title: "Brokerage Accounts", description: "What a brokerage account is and how to choose one.", level: "level-2", tags: ["brokerage", "investing-basics", "level-2"], estimatedTimeMin: 6, sources: [{ name: "SEC — Brokerage Accounts", url: "https://www.investor.gov/introduction-investing/investing-basics/how-stock-markets-work", type: "government", lastReviewed: "2026-01-01" }] },
  { id: "dividends", title: "Dividends", description: "What dividends are and how they fit into investing.", level: "level-2", tags: ["dividends", "stocks", "investing-basics", "level-2"], estimatedTimeMin: 6, sources: [{ name: "SEC — Dividends", url: "https://www.investor.gov/introduction-investing/investing-basics/investment-products/stocks", type: "government", lastReviewed: "2026-01-01" }] },
  { id: "real-estate-basics", title: "Real Estate Basics", description: "Introduction to real estate as an asset class.", level: "level-2", tags: ["real-estate", "investing-basics", "level-2"], estimatedTimeMin: 7, sources: [{ name: "CFPB — Owning a Home", url: "https://www.consumerfinance.gov/owning-a-home/", type: "regulator", lastReviewed: "2026-01-01" }] },
  { id: "reits-vs-rental", title: "REITs vs. Rental Property", description: "Compare owning rental property to investing in REITs.", level: "level-3", tags: ["real-estate", "investing-basics", "level-3", "visual-heavy"], estimatedTimeMin: 8, sources: [{ name: "SEC — REITs", url: "https://www.investor.gov/introduction-investing/investing-basics/investment-products/real-estate-investment-trusts-reits", type: "government", lastReviewed: "2026-01-01" }] },
  { id: "options-overview", title: "Options Overview (Risk-First Framing)", description: "What options are and why they are high-risk. Educational only.", level: "level-5", tags: ["options", "advanced-investing", "level-5"], estimatedTimeMin: 9, sources: [{ name: "SEC — Options", url: "https://www.investor.gov/introduction-investing/investing-basics/investment-products/options", type: "government", lastReviewed: "2026-01-01" }] },

  /* ══════════════════════════════════════════════════════
     Real Estate / Housing
  ══════════════════════════════════════════════════════ */
  { id: "rent-vs-buy-basics", title: "Rent vs. Buy Basics", description: "When renting or buying a home makes more sense.", level: "level-1", tags: ["home-buying", "real-estate", "visual-heavy", "level-1"], estimatedTimeMin: 8, sources: [{ name: "CFPB — Renting vs. Buying", url: "https://www.consumerfinance.gov/owning-a-home/", type: "regulator", lastReviewed: "2026-01-01" }] },
  { id: "down-payment-planning", title: "Down Payment Planning", description: "How much to save for a down payment and where to keep it.", level: "level-1", tags: ["home-buying", "real-estate", "level-1"], estimatedTimeMin: 6, sources: [{ name: "CFPB — Down Payment", url: "https://www.consumerfinance.gov/owning-a-home/", type: "regulator", lastReviewed: "2026-01-01" }] },
  { id: "mortgage-basics", title: "Mortgage Basics", description: "How mortgages work: principal, interest, term, and types.", level: "level-2", tags: ["home-buying", "real-estate", "level-2"], estimatedTimeMin: 9, sources: [{ name: "CFPB — Mortgages", url: "https://www.consumerfinance.gov/owning-a-home/", type: "regulator", lastReviewed: "2026-01-01" }] },
  { id: "real-estate-investing-overview", title: "Real Estate Investing Overview", description: "Ways to invest in real estate without buying a house.", level: "level-2", tags: ["real-estate", "investing-basics", "level-2"], estimatedTimeMin: 7, sources: [{ name: "SEC — REITs", url: "https://www.investor.gov/introduction-investing/investing-basics/investment-products/real-estate-investment-trusts-reits", type: "government", lastReviewed: "2026-01-01" }] },
];
